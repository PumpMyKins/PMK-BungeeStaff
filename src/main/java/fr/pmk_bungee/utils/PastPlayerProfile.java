...
public class PastPlayerProfile {
	...
	private ArrayList<String> pastBan;
	...
	public void init() {
		try {
			...
			while(rs.next()) {
				...
				this.pastBan.add(String.valueOf(rs.getInt("banid")));
			}
	...
	public ArrayList<String> getPastBan() {
		return pastBan;
	}

	public void setPastBan(ArrayList<String> pastBan) {
