...
public class InformationCommand extends Command {
	...
	public void showBan(List<Ban> lb, CommandSender pp) {
		...
		if(!lb.isEmpty()) {
			...
			for(Ban b : lb) {
				...
				bc3.addExtra(bc3bis);
				TextComponent bc4 = new TextComponent("Dur�e du ban :");
			...
			TextComponent bc2 = new TextComponent("Le joueur n'a jamais �t� banni");
	...
	public void showMute(List<Mute> lm, CommandSender pp) {
		...
		if(!lm.isEmpty()) {
			...
			for(Mute m : lm) {
				...
				bc3bis.setColor(ChatColor.GOLD);
				bc3.addExtra(bc3bis);
				TextComponent bc4 = new TextComponent("Dur�e du Mute :");
				bc4.setColor(ChatColor.BLUE);
			...
			TextComponent bc2 = new TextComponent("Le joueur n'a jamais �t� mute");
			bc2.setColor(ChatColor.DARK_GREEN);
	...
	public void showWarn(List<Warn> lw, CommandSender pp) {
		...
		if(!lw.isEmpty()) {
			...
			TextComponent bc2 = new TextComponent("Le joueur n'a jamais �t� warn");
			bc2.setColor(ChatColor.DARK_GREEN);
	...
	public void showKick(List<Kick> lk, CommandSender pp) {
		...
		if(!lk.isEmpty()) {
			...
			TextComponent bc2 = new TextComponent("Le joueur n'a jamais �t� kick");
			bc2.setColor(ChatColor.DARK_GREEN);
	...
	public void showPlayer(BungeePlayer bp, CommandSender pp) {
		...
		bc4bis.setColor(ChatColor.GOLD);
		bc4.addExtra(bc4bis);
		TextComponent bc5 = new TextComponent("Premi�re connection :");
		bc5.setColor(ChatColor.BLUE);
		TextComponent bc5bis = new TextComponent(bp.getFirstCome().toString());
		bc5bis.setColor(ChatColor.GOLD);
		bc5.addExtra(bc5bis);
		TextComponent bc6 = new TextComponent("Derni�re connection :");
		bc6.setColor(ChatColor.BLUE);
